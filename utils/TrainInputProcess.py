...
class TrainInputProcess:
    def __init__(self, 
        ...
        self.image_process = ViTImageProcessor.from_pretrained('/root/autodl-tmp/vit-base-patch16-224-in21k',use_fast=True)
    ...
    def generate_im2t_input(self):
        ...
        if self.image_gen_model_type == 'ved':
            ...
            image_processor = ViTImageProcessor.from_pretrained(self.image_gen_text_model,use_fast=True)
...
def main():
    ...
    if text_model_type == 'bert':
        text_model = '/root/autodl-tmp/roberta-base'
    elif text_model_type == 'roberta':
        text_model = '/root/autodl-tmp/roberta-base'

    if image_model_type == 'vit':
        image_model = '/root/autodl-tmp//vit-base-patch16-224-in21k'
    ...
    if finetune_task == 'im2t':
        ...
        if image_gen_model_type == 'ved':
            image_gen_text_model = '/root/autodl-tmp/vit-gpt2-image-captioning/'
        elif image_gen_model_type == 'blip':
            image_gen_text_model = '/root/autodl-tmp/blip-image-captioning-base/'
    elif finetune_task == 'clipc':
        image_model = '/root/autodl-tmp/models/clip-vit-base-patch32/'

    data_text_dir = None
    data_image_dir = None
    if dataset_type == '2015':
        data_text_dir = '/root/autodl-tmp/IJCAI2019_data/twitter2015/'
        data_image_dir = '/root/autodl-tmp/IJCAI2019_data/twitter2015_images/'
    elif dataset_type == '2017':
        data_text_dir = '/root/autodl-tmp/IJCAI2019_data/twitter2017/'
        data_image_dir = '/root/autodl-tmp/IJCAI2019_data/twitter2017_images/'
